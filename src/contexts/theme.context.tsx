...
import { createTheme, Theme as MaterialTheme, ThemeProvider as MuiProvider } from "@material-ui/core/styles";
...
const ThemeProvider = memo(({ children }: PropsWithChildren<{}>) => {
  const theme = useMemo(() => {
    const basicTheme = createTheme({
      ...
      typography: {
        fontFamily: ["Inter", "Lucida Console", '"Courier New"', "monospace"].join(","),
      },
    });
  ...
  return (
    <ThemeContext.Provider value={{ theme }}>
      <Helmet>
        ...
        <link
          rel="prefetch"
          href="https://fonts.googleapis.com/css2?family=Inter:wght@200..700"
          as="style"
          crossOrigin="true"
        />
      </Helmet>
